...
## Что внутри Особенности версии:
В данном форке реализована система Focus + Contex. При фильтрации данных структура карты не меняется, что позволяет видеть реальную долю выбранного сегмента относительно всего рынка. 
Кликайте по строкам статистики для мультивыбора: выбор в одной панели суммирует результаты (логическое <i>ИЛИ</i>), выбор в разных панелях находит пересечение (логическое <i>И</i>). Текст обоснования ИИ доступен во всех режимах просмотра.</p>
